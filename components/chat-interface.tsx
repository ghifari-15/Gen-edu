...
import { ArrowUp, Brain, Sparkles, RotateCcw } from "lucide-react"
            ...
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">
                  {useReasoning ? 'DeepSeek Reasoning Mode' : 'Claude Sonnet Mode'}
                </p>
              </div>
            </div>
          </div>
                  ...
                  >
                    ...
                    {message.sender === "ai" && message.model && (
                      <span className="ml-2 px-1.5 py-0.5 bg-gray-200 rounded text-gray-600 text-xs">
                        {message.model === 'deepseek-reasoning' ? 'Reasoning' : 'Claude'}
                      </span>
                    )}
                  </div>
                </div>
